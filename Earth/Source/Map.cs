...
namespace Earth
{
   ...
   public class Map : GMapControl
   {
      ...
      protected override void OnPaintOverlays(System.Drawing.Graphics g)
      {
         ...
         g.DrawString(Zoom + "z, " + MapProvider + ", refresh: " + counter++ + ", load: " + ElapsedMilliseconds + "ms, render: " + delta + "ms", DebugFont, Brushes.Black, DebugFont.Height, DebugFont.Height + 20);
