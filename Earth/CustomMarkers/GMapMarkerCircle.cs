...
namespace Earth.CustomMarkers
{
...
#endif
   {
      ...
      [NonSerialized]
#if !PocketPC
      public Pen Stroke = new Pen(Color.FromArgb(155, Color.MidnightBlue), 2);
#else
      ...
      [NonSerialized]
#if !PocketPC
      public Brush Fill = new SolidBrush(Color.FromArgb(155, Color.Orange));
#else
